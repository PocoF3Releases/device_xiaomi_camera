...
public final class IFileListResult {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(vendor.xiaomi.hardware.misys.HidlVector.byteSize(_hidl_vec_size, 32), _hidl_blob.handle(), _hidl_offset + 8 + 0, true);
        this.fileList.clear();
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            IFileInfo _hidl_vec_element = new IFileInfo();
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_0 * 32L);
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            this.fileList.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 32L);
        }
