...
public final class IFileInfo {
    ...
    public static final ArrayList<IFileInfo> readVectorFromParcel(HwParcel parcel) {
        ...
        HwBlob childBlob = parcel.readEmbeddedBuffer(vendor.xiaomi.hardware.misys.HidlVector.byteSize(_hidl_vec_size, 32), _hidl_blob.handle(), 0L, true);
        _hidl_vec.clear();
    ...
    public static final void writeVectorToParcel(HwParcel parcel, ArrayList<IFileInfo> _hidl_vec) {
        ...
        for (int _hidl_index_0 = 0; _hidl_index_0 < _hidl_vec_size; _hidl_index_0++) {
            _hidl_vec.get(_hidl_index_0).writeEmbeddedToBlob(childBlob, _hidl_index_0 * 32L);
        }
