...
public interface IMiSys extends IBase {
    ...
    IFileListResult DirListFiles(String str) throws RemoteException;

    int EraseFileOrDirectory(String str, String str2) throws RemoteException;

    IReadResult MiSysReadFile(String str, String str2) throws RemoteException;

    int MiSysWriteFile(String str, String str2, String str3, int i, byte b) throws RemoteException;
    ...
    public static final class Proxy implements IMiSys {
        ...
        @Override
        public IFileListResult DirListFiles(String path) throws RemoteException {
            ...
            try {
                ...
                IFileListResult _hidl_out_result = new IFileListResult();
        ...
        @Override
        public int MiSysWriteFile(String path, String file_name, String writebuf, int sbuf_len, byte append_data) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMiSys.kInterfaceName);
            _hidl_request.writeString(path);
            _hidl_request.writeString(file_name);
            _hidl_request.writeString(writebuf);
            _hidl_request.writeInt32(sbuf_len);
            _hidl_request.writeInt8(append_data);
            HwParcel _hidl_reply = new HwParcel();
            try {
        ...
        @Override
        public IReadResult MiSysReadFile(String path, String file_name) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMiSys.kInterfaceName);
            _hidl_request.writeString(path);
            _hidl_request.writeString(file_name);
            ...
            try {
                ...
                _hidl_reply.verifySuccess();
                IReadResult _hidl_out_result = new IReadResult();
                _hidl_out_result.readFromParcel(_hidl_reply);
                return _hidl_out_result;
            } finally {
                _hidl_request.releaseTemporaryStorage();
        ...
        @Override
        public int EraseFileOrDirectory(String path, String file_name) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMiSys.kInterfaceName);
            _hidl_request.writeString(path);
            _hidl_request.writeString(file_name);
    ...
    public static abstract class Stub extends HwBinder implements IMiSys {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-15, -58, 51, -24, -22, -111, -37, -51, -90, -31, 106, 108, 63, -2, -53, -94, 35, 106, 80, -61, 8, 71, -10, 15, 72, 84, -117, 116, 34, -21, -75, -91}, new byte[]{-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                case 1:
                    ...
                    IFileListResult _hidl_out_result = DirListFiles(path);
                ...
                case 2:
                    ...
                    String writebuf = _hidl_request.readString();
                    int sbuf_len = _hidl_request.readInt32();
                    byte append_data = _hidl_request.readInt8();
                    int _hidl_out_ret = MiSysWriteFile(path2, file_name, writebuf, sbuf_len, append_data);
                    _hidl_reply.writeStatus(0);
                ...
                case 3:
                    ...
                    IReadResult _hidl_out_result2 = MiSysReadFile(path3, file_name2);
                    _hidl_reply.writeStatus(0);
                ...
                case 4:
                    ...
                    int _hidl_out_ret2 = EraseFileOrDirectory(path4, file_name3);
                    _hidl_reply.writeStatus(0);
