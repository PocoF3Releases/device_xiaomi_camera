...
public interface IMiSys extends IBase {
    public static final String kInterfaceName = "vendor.xiaomi.hardware.misys@4.0::IMiSys";

    IPartitionSizeResult GetPartitionSize(String str, String str2) throws RemoteException;
    ...
    public static final class Proxy implements IMiSys {
        ...
        public String toString() {
            try {
                ...
                return "[class or subclass of vendor.xiaomi.hardware.misys@4.0::IMiSys]@Proxy";
            }
        }
        ...
        @Override
        public IPartitionSizeResult GetPartitionSize(String path, String partitionName) throws RemoteException {
            HwParcel _hidl_request = new HwParcel();
            _hidl_request.writeInterfaceToken(IMiSys.kInterfaceName);
            _hidl_request.writeString(path);
            _hidl_request.writeString(partitionName);
            HwParcel _hidl_reply = new HwParcel();
            try {
                this.mRemote.transact(1, _hidl_request, _hidl_reply, 0);
                _hidl_reply.verifySuccess();
                IPartitionSizeResult _hidl_out_sizeResult = new IPartitionSizeResult();
                _hidl_out_sizeResult.readFromParcel(_hidl_reply);
                return _hidl_out_sizeResult;
            } finally {
    ...
    public static abstract class Stub extends HwBinder implements IMiSys {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(new byte[]{-2, 17, 53, -102, 95, 61, 122, -90, -125, 94, 103, 29, -93, -93, 24, 81, -115, 45, -23, -20, 123, -21, -8, -108, -124, -88, -78, 117, -21, -10, 120, -51}, new byte[]{-20, 127, -41, -98, -48, 45, -6, -123, -68, 73, -108, 38, -83, -82, 62, -66, 35, -17, 5, 36, -13, -51, 105, 87, 19, -109, 36, -72, 59, 24, -54, 76}));
        }
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                case 1:
                    ...
                    String partitionName = _hidl_request.readString();
                    IPartitionSizeResult _hidl_out_sizeResult = GetPartitionSize(path, partitionName);
                    _hidl_reply.writeStatus(0);
                    _hidl_out_sizeResult.writeToParcel(_hidl_reply);
                    _hidl_reply.send();
                    return;
                case 256067662:
